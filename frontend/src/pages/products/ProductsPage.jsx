...
import { Barcode, Boxes, CircleDollarSign, Filter, Package, Pencil, Plus, Search, Tag, ToggleLeft, ToggleRight, Wrench, X } from "lucide-react";
      ...
      <section className="rounded-lg border border-zera-line bg-white p-6 shadow-soft">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold sm:text-3xl">Products</h2>
            <p className="mt-3 max-w-2xl leading-7 text-zera-muted">
              Create the simple items that POS can search later. Stock, purchasing, and inventory counts are intentionally not built yet.
            </p>
          </div>
      ...
      {!activeBusiness ? (
        ...
        <>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            ...
            <Metric icon={ToggleLeft} label="Inactive" value={loading ? "..." : inactiveProducts.length} />
          </section>
